...
@section('content')
    <div class="container" style="margin-top: 20px;">
        ...
        @else
            <form action="{{route('data.remove.store')}}" method="POST">
                @csrf
                <label>Delete level</label>
                <div class="form-check">
                    <input type="radio" name="deleteMethod" value="hard" class="form-check-input">
                    <label class="form-check-label">Hard delete</label>
                </div>
                <div class="form-check">
                    <input type="radio" name="deleteMethod" value="soft" class="form-check-input">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <p>The following consequences will occur:</p>
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-danger">I am sure. Please remove my data</button>
