...
@section('message-content')
    ...
    <a href="https://training.czvr.ca" style="display:inline-block; padding:10px 20px; background-color:#007bff; color:#fff; text-decoration:none; border-radius:4px;">Submit Availability</a><br/>
