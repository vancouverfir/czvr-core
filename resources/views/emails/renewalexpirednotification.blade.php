...
@section('message-content')
    ...
    <p>To ensure our students and visitors on the waitlist are still interested in continuing their training, we periodically ask you to renew your training request.</p><br/>
