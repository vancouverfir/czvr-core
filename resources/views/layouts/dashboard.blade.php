                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-default py-0" aria-labelledby="navbarDropdownMenuLink-333">
                                ...
                                @if (auth()->check() && (auth()->user()->studentProfile))
                                    <a class="dropdown-item {{ Request::is('training') || Request::is('/training/')}}" href="{{route('training.index')}}">
                                        <i class="fas fas fa-chalkboard-teacher mr-2"></i>Training
                                    </a>
                                @elseif (auth()->check() && auth()->user()->permissions == 2)
                                    <a class="dropdown-item {{ Request::is('training') || Request::is('/training/')}}" href="{{route('training.index')}}">
                                        <i class="fas fas fa-chalkboard-teacher mr-2"></i>Mentors
                                    </a>
                                @elseif (auth()->check() && (auth()->user()->instructorProfile))
                                    <a class="dropdown-item {{ Request::is('training') || Request::is('/training/')}}" href="{{route('training.index')}}">
                                        <i class="fas fas fa-chalkboard-teacher mr-2"></i>Instructors
                                    </a>
                                @endif
