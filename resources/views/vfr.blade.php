...
<link rel="stylesheet" type="text/css" href="{{ asset('/css/home.css') }}" />
    ...
    <div class="container py-4">
        ...
        <p class="text-colour">CZVR is home to some of the most beautiful landscapes to navigate visually. 
        ...
        Procedures may be assigned based on destination and traffic. The most up to date of these can be found here:</p>
            <h5 class="text-colour"><a href="http://imageserver.fltplan.com/legends/VTA_BACK_VANCOUVER.PDF" class="text-colour"><text>VTA Back Vancouver</text></a></h5>
            <h5 class="text-colour"><a href="https://imageserver.fltplan.com/legends/BC_VFR_TERMINAL_PROCEDURES_10-07-2021.PDF" class="text-colour"><text>Canadian Flight Supplement - BC VFR Terminal Procedures</text></a></h5>
        <hr>
        ...
        <hr>
        <p class="text-colour">Many of the following procedures indicated points to report/frequency change from inner to outer tower. 
