...
<link rel="stylesheet" type="text/css" href="{{ asset('/css/home.css') }}" />
    ...
    <div class="container py-4">
        ...
        Procedures may be assigned based on destination and traffic. The most up to date of these can be found here:</p>
            ...
            <h5 class="text-colour content-link"><a href="https://imageserver.fltplan.com/legends/BC_VFR_TERMINAL_PROCEDURES_10-02-2025.PDF" class="text-colour"><text>Canadian Flight Supplement - BC VFR Terminal Procedures</text></a></h5>
        <hr>
