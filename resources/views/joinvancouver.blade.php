...
@section('title', 'Join - Vancouver FIR')
@section('description', 'Join the Vancouver FIR!')
		...
		<div class="card-body">	
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="new" role="tabpanel" aria-labelledby="new">
					...
					<ol>
						<li>You will need to join the VATCAN division. If you have not already joined, or skipped some steps from Step 1, click the following link to set your region:<span> </span><a href="https://cert.vatsim.net/vatsimnet/regch.php" target="_blank" rel="noopener noreferrer">https://cert.vatsim.net/vatsimnet/regch.php</a>. You may proceed to step 5 if you are already a part of VATCAN.</li>
					...
					<ol>
						<li><a href="https://vatcan.ca/login" target="_blank" rel="noopener noreferrer">Login into VATCAN</a> using your VATSIM CID and password.</li>
						<li>Click on <strong>My</strong> <strong>VATCAN</strong>, then on <strong>Transfer Request</strong>.</li>
						<li>In the <strong>New FIR</strong> drop-down, select <strong>Vancouver FIR</strong>.</li>
				...
				<div class="tab-pane fade" id="visit" role="tabpanel" aria-labelledby="visit"><br>
					<div class="card">	
						<div class="card-body bg-info">
							<text class="font-weight-bold">NOTE:</text> Vancouver is currently busy with a home controller wait list - this may result in lengthy delays for visiting controllers awaiting training. Controllers will be contacted with updates when available. Thank you for your patience.</text>
						</div>
					</div>
					<br>
