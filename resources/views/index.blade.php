...
<link rel="stylesheet" type="text/css" href="{{ asset('/css/home.css') }}" />
    <div>
        <div data-jarallax data-speed="0.2" class="jarallax d-flex align-items-center" style="height: min(calc((100vh - 59px) / 4), 280px)">
                    ...
                    <div class="py-4 text-center">
                        ...
                        <h4 class="text-colour mt-3">
                            <span class="corner bg-dark-transparent">
                                <a href="#mid" id="discoverMore" class="blue-text">Come explore Canada's west coast <i class="fas fa-arrow-down ml-2"></i></a>
                            </span>
                        </h4>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-background mb-4">
                        ...
                        <div class="card-footer card-hf-padding blue-text text-center">
                            <a href="https://vatsim-radar.com/" target="_blank" class="btn btn-sm btn-link text-secondary px-3"><i class="fas fa-map mr-2"></i>Live VATSIM Map</a>
                        </div>
                    </div>
                </div>
            </div>
